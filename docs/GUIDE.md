...
> **Welcome to Product-Track Week 11, Task 4!**
...
| `src/commentRenderer.js` | Main source code - **has bugs to fix** |
| `src/htmlUtils.js` | Supporting code - **may also have bugs** |
| `tests/test_xss.js` | Test file - **add your tests here** |
...
### Incident - `src/commentRenderer.js`
**User Report / Alert:**
> "Directly interpolates user input into HTML without escaping"
...
### Incident - `src/commentRenderer.js`
**User Report / Alert:**
> "This sanitize function is incomplete — doesn't escape quotes"
